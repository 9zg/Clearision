...
if (!is_admin()) {
    ...
    add_action('wp_enqueue_scripts', function () {
        ...
        wp_enqueue_style('clearision-bootstrap', 'https://lib.baomitu.com/twitter-bootstrap/' . $btgirdVer . '/css/bootstrap-grid.min.css');
    });
    ...
    if (get_option('clrs_thrdptComs_jq') === 'yes') {
        add_action('wp_enqueue_scripts', function () {
            ...
            wp_register_script('jquery', 'https://lib.baomitu.com/jquery/' . $jqVer . '/jquery.min.js', [], $jqVer);
    ...
    if (get_option('clrs_thrdptComs_fa') === 'yes') {
        add_action('wp_enqueue_scripts', function () {
            ...
            wp_enqueue_style('clearision-font-awesome', 'https://lib.baomitu.com/font-awesome/' . $faVer . '/css/font-awesome.min.css', [], $faVer);
